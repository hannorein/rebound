...
const struct reb_binary_field_descriptor reb_binary_field_descriptor_list[]= {
    ...
    { 66, REB_UINT,         "ri_whfast.timestep_warning",   offsetof(struct reb_simulation, ri_whfast.timestep_warning), 0, 0},
    ...
    { 171, REB_INT,         "ri_trace.coordinates",        offsetof(struct reb_simulation, ri_trace.coordinates), 0, 0},
    { 172, REB_DOUBLE,      "ri_trace.r_crit_WB",         offsetof(struct reb_simulation, ri_trace.r_crit_WB), 0, 0},
