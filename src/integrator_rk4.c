/**
 * @file 	integrator.c
 * @brief 	Runge Kutta 4th degree integration scheme.
 * @author 	Sergi Blanco-Cuaresma
 * @detail	This file implements the Runge Kutta 4th degree integration scheme.  
 * 
 * @section 	LICENSE
...
// These variables have no effect for runge kutta.
...
/**
 * This part has no function, as the runge kutta scheme does not have any sub-
 * timestep.
 */
...
void integrator_part2(){
    double* x0      = NULL;            // Temporary buffer for position
