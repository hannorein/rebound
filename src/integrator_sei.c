...
static void operator_H012(double dt, const struct reb_context_integrator_sei ri_sei, struct reb_particle* p);
...
void reb_integrator_sei_part1(struct reb_context* const r){
	...
	const struct reb_context_integrator_sei ri_sei = r->ri_sei;
