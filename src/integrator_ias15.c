...
static void copybuffers(double* const _a[7], double* const _b[7], int N3);
static void predict_next_step(double ratio, int N3, double* restrict _e[7], double* restrict _b[7], double* restrict e[7], double* restrict b[7]);
