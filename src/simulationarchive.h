...
void reb_read_simulationarchive_with_messages(struct reb_simulationarchive* sa, const char* filename, struct reb_simulationarchive* sa_shape, enum reb_input_binary_messages* warnings, int recovery_mode); ///< Internal function to read one snapshot from a simulation archive.
