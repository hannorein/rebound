...
void reb_integrator_trace_wb_to_inertial(struct reb_simulation* r); ///< Internal in-place coordinate transformation
void reb_integrator_trace_inertial_to_wb(struct reb_simulation* r); ///< Internal in-place coordinate transformation
#endif
