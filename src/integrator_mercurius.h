...
double reb_integrator_mercurius_calculate_dcrit_for_particle(struct reb_simulation* r, size_t i); ///< Internal function for calculating dcrit in reb_simulation_add_local
#endif
