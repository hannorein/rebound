...
//    { 60, REB_DOUBLE,       "ri_sei.tandtz",                offsetof(struct reb_simulation, ri_sei.tandtz), 0, 0},
    ...
    { 105, REB_POINTER,     "ri_whfast.p_jh_var",           offsetof(struct reb_simulation, ri_whfast.p_jh_var), offsetof(struct reb_simulation, ri_whfast.N_allocated_var), sizeof(struct reb_particle)},
