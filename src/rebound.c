...
const struct reb_binary_field_descriptor reb_binary_field_descriptor_list[]= {
    ...
    { 104, REB_OTHER,   "ri_whfast.p_jh", offsetof(struct reb_simulation, ri_whfast.p_jh)},
    ...
    { 112, REB_OTHER,   "ri_janus.p_int", offsetof(struct reb_simulation, ri_janus.p_int)},
    ...
    { 143, REB_UINT,    "whfast_corrector2", offsetof(struct reb_simulation, whfast_corrector2)},
