...
const struct reb_binary_field_descriptor reb_binary_field_descriptor_list[]= {
    ...
    { 6,  REB_INT,      "var_config_N", offsetof(struct reb_simulation, var_config_N)},
    ...
    { 15, REB_DOUBLE,   "OUTPUTTIMINGLAST", offsetof(struct reb_simulation, OUTPUTTIMINGLAST)},
    { 16, REB_DOUBLE,   "SAVEMESSAGES", offsetof(struct reb_simulation, SAVEMESSAGES)},
    { 17, REB_DOUBLE,   "EXITMAXDISTANCE", offsetof(struct reb_simulation, EXITMAXDISTANCE)},
    { 18, REB_DOUBLE,   "EXITMINDISTANCE", offsetof(struct reb_simulation, EXITMINDISTANCE)},
    { 19, REB_DOUBLE,   "USLEEP", offsetof(struct reb_simulation, USLEEP)},
    { 20, REB_DOUBLE,   "TRACKENERGYOFFSET", offsetof(struct reb_simulation, TRACKENERGYOFFSET)},
    { 21, REB_DOUBLE,   "ENERGYOFFSET", offsetof(struct reb_simulation, ENERGYOFFSET)},
    { 22, REB_DOUBLE,   "BOXSIZE", offsetof(struct reb_simulation, BOXSIZE)},
    { 23, REB_DOUBLE,   "BOXSIZEMAX", offsetof(struct reb_simulation, BOXSIZEMAX)},
    { 24, REB_DOUBLE,   "ROOTSIZE", offsetof(struct reb_simulation, ROOTSIZE)},
    { 25, REB_DOUBLE,   "ROOTN", offsetof(struct reb_simulation, ROOTN)},
    { 26, REB_DOUBLE,   "ROOTNX", offsetof(struct reb_simulation, ROOTNX)},
    { 27, REB_DOUBLE,   "ROOTNY", offsetof(struct reb_simulation, ROOTNY)},
    { 28, REB_DOUBLE,   "ROOTNZ", offsetof(struct reb_simulation, ROOTNZ)},
    { 29, REB_DOUBLE,   "NGHOSTX", offsetof(struct reb_simulation, NGHOSTX)},
    { 30, REB_DOUBLE,   "NGHOSTY", offsetof(struct reb_simulation, NGHOSTY)},
    { 31, REB_DOUBLE,   "NGHOSTZ", offsetof(struct reb_simulation, NGHOSTZ)},
    { 32, REB_DOUBLE,   "COLLISIONRESOLVEKEEPSORTED", offsetof(struct reb_simulation, COLLISIONRESOLVEKEEPSORTED)},
    { 33, REB_DOUBLE,   "MINIMUMCOLLISIONVELOCITY", offsetof(struct reb_simulation, MINIMUMCOLLISIONVELOCITY)},
    { 34, REB_DOUBLE,   "COLLISIONSPLOG", offsetof(struct reb_simulation, COLLISIONSPLOG)},
    { 35, REB_DOUBLE,   "MAXRADIUS", offsetof(struct reb_simulation, MAXRADIUS)},
    { 36, REB_DOUBLE,   "COLLISIONSNLOG", offsetof(struct reb_simulation, COLLISIONSNLOG)},
    { 37, REB_DOUBLE,   "CALCULATEMEGNO", offsetof(struct reb_simulation, CALCULATEMEGNO)},
    { 38, REB_DOUBLE,   "MEGNOYS", offsetof(struct reb_simulation, MEGNOYS)},
    { 39, REB_DOUBLE,   "MEGNOYSS", offsetof(struct reb_simulation, MEGNOYSS)},
    { 40, REB_DOUBLE,   "MEGNOCOVYT", offsetof(struct reb_simulation, MEGNOCOVYT)},
    { 41, REB_DOUBLE,   "MEGNOVART", offsetof(struct reb_simulation, MEGNOVART)},
    { 42, REB_DOUBLE,   "MEGNOMEANT", offsetof(struct reb_simulation, MEGNOMEANT)},
    { 43, REB_DOUBLE,   "MEGNOMEANY", offsetof(struct reb_simulation, MEGNOMEANY)},
    { 44, REB_DOUBLE,   "MEGNON", offsetof(struct reb_simulation, MEGNON)},
    { 45, REB_DOUBLE,   "SASIZEFIRST", offsetof(struct reb_simulation, SASIZEFIRST)},
    { 46, REB_DOUBLE,   "SASIZESNAPSHOT", offsetof(struct reb_simulation, SASIZESNAPSHOT)},
    { 47, REB_DOUBLE,   "SAAUTOINTERVAL", offsetof(struct reb_simulation, SAAUTOINTERVAL)},
    { 102, REB_DOUBLE,   "SAAUTOWALLTIME", offsetof(struct reb_simulation, SAAUTOWALLTIME)},
    { 48, REB_DOUBLE,   "SANEXT", offsetof(struct reb_simulation, SANEXT)},
    { 50, REB_DOUBLE,   "COLLISION", offsetof(struct reb_simulation, COLLISION)},
    { 51, REB_DOUBLE,   "INTEGRATOR", offsetof(struct reb_simulation, INTEGRATOR)},
    { 52, REB_DOUBLE,   "BOUNDARY", offsetof(struct reb_simulation, BOUNDARY)},
    { 53, REB_DOUBLE,   "GRAVITY", offsetof(struct reb_simulation, GRAVITY)},
    { 54, REB_DOUBLE,   "SEI_OMEGA", offsetof(struct reb_simulation, SEI_OMEGA)},
    { 55, REB_DOUBLE,   "SEI_OMEGAZ", offsetof(struct reb_simulation, SEI_OMEGAZ)},
    { 56, REB_DOUBLE,   "SEI_LASTDT", offsetof(struct reb_simulation, SEI_LASTDT)},
    { 57, REB_DOUBLE,   "SEI_SINDT", offsetof(struct reb_simulation, SEI_SINDT)},
    { 58, REB_DOUBLE,   "SEI_TANDT", offsetof(struct reb_simulation, SEI_TANDT)},
    { 59, REB_DOUBLE,   "SEI_SINDTZ", offsetof(struct reb_simulation, SEI_SINDTZ)},
    { 60, REB_DOUBLE,   "SEI_TANDTZ", offsetof(struct reb_simulation, SEI_TANDTZ)},
    { 61, REB_DOUBLE,   "WHFAST_CORRECTOR", offsetof(struct reb_simulation, WHFAST_CORRECTOR)},
    { 62, REB_DOUBLE,   "WHFAST_RECALCJAC", offsetof(struct reb_simulation, WHFAST_RECALCJAC)},
    { 63, REB_DOUBLE,   "WHFAST_SAFEMODE", offsetof(struct reb_simulation, WHFAST_SAFEMODE)},
    { 64, REB_DOUBLE,   "WHFAST_KEEPUNSYNC", offsetof(struct reb_simulation, WHFAST_KEEPUNSYNC)},
    { 65, REB_DOUBLE,   "WHFAST_ISSYNCHRON", offsetof(struct reb_simulation, WHFAST_ISSYNCHRON)},
    { 66, REB_DOUBLE,   "WHFAST_TIMESTEPWARN", offsetof(struct reb_simulation, WHFAST_TIMESTEPWARN)},
    { 69, REB_DOUBLE,   "IAS15_EPSILON", offsetof(struct reb_simulation, IAS15_EPSILON)},
    { 70, REB_DOUBLE,   "IAS15_MINDT", offsetof(struct reb_simulation, IAS15_MINDT)},
    { 71, REB_DOUBLE,   "IAS15_EPSILONGLOBAL", offsetof(struct reb_simulation, IAS15_EPSILONGLOBAL)},
    { 72, REB_DOUBLE,   "IAS15_ITERATIONSMAX", offsetof(struct reb_simulation, IAS15_ITERATIONSMAX)},
    { 85, REB_DOUBLE,   "PARTICLES", offsetof(struct reb_simulation, PARTICLES)},
    { 86, REB_DOUBLE,   "VARCONFIG", offsetof(struct reb_simulation, VARCONFIG)},
    { 87, REB_DOUBLE,   "FUNCTIONPOINTERS", offsetof(struct reb_simulation, FUNCTIONPOINTERS)},
    { 88, REB_DOUBLE,   "IAS15_ALLOCATEDN", offsetof(struct reb_simulation, IAS15_ALLOCATEDN)},
    { 89, REB_DOUBLE,   "IAS15_AT", offsetof(struct reb_simulation, IAS15_AT)},
    { 90, REB_DOUBLE,   "IAS15_X0", offsetof(struct reb_simulation, IAS15_X0)},
    { 91, REB_DOUBLE,   "IAS15_V0", offsetof(struct reb_simulation, IAS15_V0)},
    { 92, REB_DOUBLE,   "IAS15_A0", offsetof(struct reb_simulation, IAS15_A0)},
    { 93, REB_DOUBLE,   "IAS15_CSX", offsetof(struct reb_simulation, IAS15_CSX)},
    { 94, REB_DOUBLE,   "IAS15_CSV", offsetof(struct reb_simulation, IAS15_CSV)},
    { 95, REB_DOUBLE,   "IAS15_CSA0", offsetof(struct reb_simulation, IAS15_CSA0)},
    { 96, REB_DOUBLE,   "IAS15_G", offsetof(struct reb_simulation, IAS15_G)},
    { 97, REB_DOUBLE,   "IAS15_B", offsetof(struct reb_simulation, IAS15_B)},
    { 98, REB_DOUBLE,   "IAS15_CSB", offsetof(struct reb_simulation, IAS15_CSB)},
    { 99, REB_DOUBLE,   "IAS15_E", offsetof(struct reb_simulation, IAS15_E)},
    { 100, REB_DOUBLE,   "IAS15_BR", offsetof(struct reb_simulation, IAS15_BR)},
    { 101, REB_DOUBLE,   "IAS15_ER", offsetof(struct reb_simulation, IAS15_ER)},
    { 104, REB_DOUBLE,   "WHFAST_PJ", offsetof(struct reb_simulation, WHFAST_PJ)},
    { 107, REB_DOUBLE,   "VISUALIZATION", offsetof(struct reb_simulation, VISUALIZATION)},
    { 110, REB_DOUBLE,   "JANUS_ALLOCATEDN", offsetof(struct reb_simulation, JANUS_ALLOCATEDN)},
    { 112, REB_DOUBLE,   "JANUS_PINT", offsetof(struct reb_simulation, JANUS_PINT)},
    { 113, REB_DOUBLE,   "JANUS_SCALEPOS", offsetof(struct reb_simulation, JANUS_SCALEPOS)},
    { 114, REB_DOUBLE,   "JANUS_SCALEVEL", offsetof(struct reb_simulation, JANUS_SCALEVEL)},
    { 115, REB_DOUBLE,   "JANUS_ORDER", offsetof(struct reb_simulation, JANUS_ORDER)},
    { 116, REB_DOUBLE,   "JANUS_RECALC", offsetof(struct reb_simulation, JANUS_RECALC)},
    { 117, REB_DOUBLE,   "WHFAST_COORDINATES", offsetof(struct reb_simulation, WHFAST_COORDINATES)},
    { 118, REB_DOUBLE,   "MERCURIUS_HILLFAC", offsetof(struct reb_simulation, MERCURIUS_HILLFAC)},
    { 119, REB_DOUBLE,   "MERCURIUS_SAFEMODE", offsetof(struct reb_simulation, MERCURIUS_SAFEMODE)},
    { 120, REB_DOUBLE,   "MERCURIUS_ISSYNCHRON", offsetof(struct reb_simulation, MERCURIUS_ISSYNCHRON)},
    { 122, REB_DOUBLE,   "MERCURIUS_DCRIT", offsetof(struct reb_simulation, MERCURIUS_DCRIT)},
    { 123, REB_DOUBLE,   "MERCURIUS_RECALCULATE_COORD", offsetof(struct reb_simulation, MERCURIUS_RECALCULATE_COORD)},
    { 125, REB_DOUBLE,   "SAVERSION", offsetof(struct reb_simulation, SAVERSION)},
    { 126, REB_DOUBLE,   "WALLTIME", offsetof(struct reb_simulation, WALLTIME)},
    { 130, REB_DOUBLE,   "PYTHON_UNIT_L", offsetof(struct reb_simulation, PYTHON_UNIT_L)},
    { 131, REB_DOUBLE,   "PYTHON_UNIT_M", offsetof(struct reb_simulation, PYTHON_UNIT_M)},
    { 132, REB_DOUBLE,   "PYTHON_UNIT_T", offsetof(struct reb_simulation, PYTHON_UNIT_T)},
    { 133, REB_DOUBLE,   "MERCURIUS_COMPOS", offsetof(struct reb_simulation, MERCURIUS_COMPOS)},
    { 134, REB_DOUBLE,   "MERCURIUS_COMVEL", offsetof(struct reb_simulation, MERCURIUS_COMVEL)},
    { 135, REB_DOUBLE,   "SAAUTOSTEP", offsetof(struct reb_simulation, SAAUTOSTEP)},
    { 136, REB_DOUBLE,   "SANEXTSTEP", offsetof(struct reb_simulation, SANEXTSTEP)},
    { 137, REB_DOUBLE,   "STEPSDONE", offsetof(struct reb_simulation, STEPSDONE)},
    { 140, REB_DOUBLE,   "SABA_SAFEMODE", offsetof(struct reb_simulation, SABA_SAFEMODE)},
    { 141, REB_DOUBLE,   "SABA_ISSYNCHRON", offsetof(struct reb_simulation, SABA_ISSYNCHRON)},
    { 143, REB_DOUBLE,   "WHFAST_CORRECTOR2", offsetof(struct reb_simulation, WHFAST_CORRECTOR2)},
    { 144, REB_DOUBLE,   "WHFAST_KERNEL", offsetof(struct reb_simulation, WHFAST_KERNEL)},
    { 145, REB_DOUBLE,   "DTLASTDONE", offsetof(struct reb_simulation, DTLASTDONE)},
    { 146, REB_DOUBLE,   "SABA_TYPE", offsetof(struct reb_simulation, SABA_TYPE)},
    { 147, REB_DOUBLE,   "SABA_KEEPUNSYNC", offsetof(struct reb_simulation, SABA_KEEPUNSYNC)},
    { 148, REB_DOUBLE,   "EOS_PHI0", offsetof(struct reb_simulation, EOS_PHI0)},
    { 149, REB_DOUBLE,   "EOS_PHI1", offsetof(struct reb_simulation, EOS_PHI1)},
    { 150, REB_DOUBLE,   "EOS_N", offsetof(struct reb_simulation, EOS_N)},
    { 151, REB_DOUBLE,   "EOS_SAFEMODE", offsetof(struct reb_simulation, EOS_SAFEMODE)},
    { 152, REB_DOUBLE,   "EOS_ISSYNCHRON", offsetof(struct reb_simulation, EOS_ISSYNCHRON)},
    { 154, REB_DOUBLE,   "RAND_SEED", offsetof(struct reb_simulation, RAND_SEED)},
    { 155, REB_DOUBLE,   "TESTPARTICLEHIDEWARNINGS", offsetof(struct reb_simulation, TESTPARTICLEHIDEWARNINGS)},
    { 156, REB_DOUBLE,   "BS_EPSABS", offsetof(struct reb_simulation, BS_EPSABS)},
    { 157, REB_DOUBLE,   "BS_EPSREL", offsetof(struct reb_simulation, BS_EPSREL)},
    { 158, REB_DOUBLE,   "BS_MINDT", offsetof(struct reb_simulation, BS_MINDT)},
    { 159, REB_DOUBLE,   "BS_MAXDT", offsetof(struct reb_simulation, BS_MAXDT)},
    { 160, REB_DOUBLE,   "BS_FIRSTORLASTSTEP", offsetof(struct reb_simulation, BS_FIRSTORLASTSTEP)},
    { 161, REB_DOUBLE,   "BS_PREVIOUSREJECTED", offsetof(struct reb_simulation, BS_PREVIOUSREJECTED)},
    { 162, REB_DOUBLE,   "BS_TARGETITER", offsetof(struct reb_simulation, BS_TARGETITER)},
    { 163, REB_DOUBLE,   "VARRESCALEWARNING", offsetof(struct reb_simulation, VARRESCALEWARNING)},
    { 300, REB_DOUBLE,   "TES_DQ_MAX", offsetof(struct reb_simulation, TES_DQ_MAX)},
    { 301, REB_DOUBLE,   "TES_RECTI_PER_ORBIT", offsetof(struct reb_simulation, TES_RECTI_PER_ORBIT)},
    { 302, REB_DOUBLE,   "TES_EPSILON", offsetof(struct reb_simulation, TES_EPSILON)},
    { 303, REB_DOUBLE,   "TES_PERIOD", offsetof(struct reb_simulation, TES_PERIOD)},
    { 304, REB_DOUBLE,   "TES_ALLOCATED_N", offsetof(struct reb_simulation, TES_ALLOCATED_N)},
    { 305, REB_DOUBLE,   "TES_PARTICLES_DH", offsetof(struct reb_simulation, TES_PARTICLES_DH)},
    { 306, REB_DOUBLE,   "TES_SV_LEN", offsetof(struct reb_simulation, TES_SV_LEN)},
    { 307, REB_DOUBLE,   "TES_SV_SIZE", offsetof(struct reb_simulation, TES_SV_SIZE)},
    { 308, REB_DOUBLE,   "TES_CV_LEN", offsetof(struct reb_simulation, TES_CV_LEN)},
    { 309, REB_DOUBLE,   "TES_CV_SIZE", offsetof(struct reb_simulation, TES_CV_SIZE)},
    { 310, REB_DOUBLE,   "TES_MASS", offsetof(struct reb_simulation, TES_MASS)},
    { 311, REB_DOUBLE,   "TES_X_DH", offsetof(struct reb_simulation, TES_X_DH)},
    { 312, REB_DOUBLE,   "TES_COM", offsetof(struct reb_simulation, TES_COM)},
    { 313, REB_DOUBLE,   "TES_COM_DOT", offsetof(struct reb_simulation, TES_COM_DOT)},
    { 314, REB_DOUBLE,   "TES_MASS_STAR_LAST", offsetof(struct reb_simulation, TES_MASS_STAR_LAST)},
    { 320, REB_DOUBLE,   "TES_UVARS_SV_SIZE", offsetof(struct reb_simulation, TES_UVARS_SV_SIZE)},
    { 321, REB_DOUBLE,   "TES_UVARS_CV_SIZE", offsetof(struct reb_simulation, TES_UVARS_CV_SIZE)},
    { 322, REB_DOUBLE,   "TES_UVARS_T0", offsetof(struct reb_simulation, TES_UVARS_T0)},
    { 323, REB_DOUBLE,   "TES_UVARS_TLAST", offsetof(struct reb_simulation, TES_UVARS_TLAST)},
    { 324, REB_DOUBLE,   "TES_UVARS_CSQ", offsetof(struct reb_simulation, TES_UVARS_CSQ)},
    { 325, REB_DOUBLE,   "TES_UVARS_CSP", offsetof(struct reb_simulation, TES_UVARS_CSP)},
    { 326, REB_DOUBLE,   "TES_UVARS_CSV", offsetof(struct reb_simulation, TES_UVARS_CSV)},
    { 327, REB_DOUBLE,   "TES_UVARS_Q0", offsetof(struct reb_simulation, TES_UVARS_Q0)},
    { 328, REB_DOUBLE,   "TES_UVARS_V0", offsetof(struct reb_simulation, TES_UVARS_V0)},
    { 329, REB_DOUBLE,   "TES_UVARS_P0", offsetof(struct reb_simulation, TES_UVARS_P0)},
    { 330, REB_DOUBLE,   "TES_UVARS_Q1", offsetof(struct reb_simulation, TES_UVARS_Q1)},
    { 331, REB_DOUBLE,   "TES_UVARS_V1", offsetof(struct reb_simulation, TES_UVARS_V1)},
    { 332, REB_DOUBLE,   "TES_UVARS_P1", offsetof(struct reb_simulation, TES_UVARS_P1)},
    { 333, REB_DOUBLE,   "TES_UVARS_X", offsetof(struct reb_simulation, TES_UVARS_X)},
    { 334, REB_DOUBLE,   "TES_UVARS_Q0_NORM", offsetof(struct reb_simulation, TES_UVARS_Q0_NORM)},
    { 335, REB_DOUBLE,   "TES_UVARS_BETA", offsetof(struct reb_simulation, TES_UVARS_BETA)},
    { 336, REB_DOUBLE,   "TES_UVARS_ETA", offsetof(struct reb_simulation, TES_UVARS_ETA)},
    { 337, REB_DOUBLE,   "TES_UVARS_ZETA", offsetof(struct reb_simulation, TES_UVARS_ZETA)},
    { 338, REB_DOUBLE,   "TES_UVARS_PERIOD", offsetof(struct reb_simulation, TES_UVARS_PERIOD)},
    { 339, REB_DOUBLE,   "TES_UVARS_XPERIOD", offsetof(struct reb_simulation, TES_UVARS_XPERIOD)},
    { 340, REB_DOUBLE,   "TES_UVARS_STUMPF_C0", offsetof(struct reb_simulation, TES_UVARS_STUMPF_C0)},
    { 341, REB_DOUBLE,   "TES_UVARS_STUMPF_C1", offsetof(struct reb_simulation, TES_UVARS_STUMPF_C1)},
    { 342, REB_DOUBLE,   "TES_UVARS_STUMPF_C2", offsetof(struct reb_simulation, TES_UVARS_STUMPF_C2)},
    { 343, REB_DOUBLE,   "TES_UVARS_STUMPF_C3", offsetof(struct reb_simulation, TES_UVARS_STUMPF_C3)},
    { 344, REB_DOUBLE,   "TES_UVARS_MU", offsetof(struct reb_simulation, TES_UVARS_MU)},
    { 350, REB_DOUBLE,   "TES_RADAU_DX", offsetof(struct reb_simulation, TES_RADAU_DX)},
    { 351, REB_DOUBLE,   "TES_RADAU_XOUT", offsetof(struct reb_simulation, TES_RADAU_XOUT)},
    { 352, REB_DOUBLE,   "TES_RADAU_RECTI_ARRAY", offsetof(struct reb_simulation, TES_RADAU_RECTI_ARRAY)},
    { 353, REB_DOUBLE,   "TES_RADAU_PREDICTORS", offsetof(struct reb_simulation, TES_RADAU_PREDICTORS)},
    { 354, REB_DOUBLE,   "TES_RADAU_DSTATE0", offsetof(struct reb_simulation, TES_RADAU_DSTATE0)},
    { 355, REB_DOUBLE,   "TES_RADAU_DDSTATE0", offsetof(struct reb_simulation, TES_RADAU_DDSTATE0)},
    { 356, REB_DOUBLE,   "TES_RADAU_DSTATE", offsetof(struct reb_simulation, TES_RADAU_DSTATE)},
    { 357, REB_DOUBLE,   "TES_RADAU_DDSTATE", offsetof(struct reb_simulation, TES_RADAU_DDSTATE)},
    { 358, REB_DOUBLE,   "TES_RADAU_CS_DSTATE0", offsetof(struct reb_simulation, TES_RADAU_CS_DSTATE0)},
    { 359, REB_DOUBLE,   "TES_RADAU_CS_DDSTATE0", offsetof(struct reb_simulation, TES_RADAU_CS_DDSTATE0)},
    { 360, REB_DOUBLE,   "TES_RADAU_CS_DSTATE", offsetof(struct reb_simulation, TES_RADAU_CS_DSTATE)},
    { 361, REB_DOUBLE,   "TES_RADAU_CS_DDSTATE", offsetof(struct reb_simulation, TES_RADAU_CS_DDSTATE)},
    { 362, REB_DOUBLE,   "TES_RADAU_CS_DX", offsetof(struct reb_simulation, TES_RADAU_CS_DX)},
    { 363, REB_DOUBLE,   "TES_RADAU_FCALLS", offsetof(struct reb_simulation, TES_RADAU_FCALLS)},
    { 364, REB_DOUBLE,   "TES_RADAU_RECTIS", offsetof(struct reb_simulation, TES_RADAU_RECTIS)},
    { 365, REB_DOUBLE,   "TES_RADAU_ITERS", offsetof(struct reb_simulation, TES_RADAU_ITERS)},
    { 366, REB_DOUBLE,   "TES_RADAU_B6", offsetof(struct reb_simulation, TES_RADAU_B6)},
    { 367, REB_DOUBLE,   "TES_RADAU_B", offsetof(struct reb_simulation, TES_RADAU_B)},
    { 368, REB_DOUBLE,   "TES_RADAU_BLAST", offsetof(struct reb_simulation, TES_RADAU_BLAST)},
    { 369, REB_DOUBLE,   "TES_RADAU_B_1ST", offsetof(struct reb_simulation, TES_RADAU_B_1ST)},
    { 370, REB_DOUBLE,   "TES_RADAU_BLAST_1ST", offsetof(struct reb_simulation, TES_RADAU_BLAST_1ST)},
    { 371, REB_DOUBLE,   "TES_RADAU_CS_B", offsetof(struct reb_simulation, TES_RADAU_CS_B)},
    { 372, REB_DOUBLE,   "TES_RADAU_CS_B_1ST", offsetof(struct reb_simulation, TES_RADAU_CS_B_1ST)},
    { 373, REB_DOUBLE,   "TES_RADAU_G", offsetof(struct reb_simulation, TES_RADAU_G)},
    { 374, REB_DOUBLE,   "TES_RADAU_G_1ST", offsetof(struct reb_simulation, TES_RADAU_G_1ST)},
    { 380, REB_DOUBLE,   "TES_DHEM_XOSC_STORE", offsetof(struct reb_simulation, TES_DHEM_XOSC_STORE)},
    { 381, REB_DOUBLE,   "TES_DHEM_XOSC_PRED_STORE", offsetof(struct reb_simulation, TES_DHEM_XOSC_PRED_STORE)},
    { 382, REB_DOUBLE,   "TES_DHEM_XOSC_CS_STORE", offsetof(struct reb_simulation, TES_DHEM_XOSC_CS_STORE)},
    { 383, REB_DOUBLE,   "TES_DHEM_XOSC_DOT_STORE", offsetof(struct reb_simulation, TES_DHEM_XOSC_DOT_STORE)},
    { 384, REB_DOUBLE,   "TES_DHEM_X", offsetof(struct reb_simulation, TES_DHEM_X)},
    { 385, REB_DOUBLE,   "TES_DHEM_M_INV", offsetof(struct reb_simulation, TES_DHEM_M_INV)},
    { 386, REB_DOUBLE,   "TES_DHEM_M_TOTAL", offsetof(struct reb_simulation, TES_DHEM_M_TOTAL)},
    { 387, REB_DOUBLE,   "TES_DHEM_RECTI_TIME", offsetof(struct reb_simulation, TES_DHEM_RECTI_TIME)},
    { 388, REB_DOUBLE,   "TES_DHEM_RECTI_PERIOD", offsetof(struct reb_simulation, TES_DHEM_RECTI_PERIOD)},
    { 390, REB_DOUBLE,   "WHFAST512_KEEPUNSYNC", offsetof(struct reb_simulation, WHFAST512_KEEPUNSYNC)},
    { 391, REB_DOUBLE,   "WHFAST512_ISSYNCHRON", offsetof(struct reb_simulation, WHFAST512_ISSYNCHRON)},
    { 392, REB_DOUBLE,   "WHFAST512_GRPOTENTIAL", offsetof(struct reb_simulation, WHFAST512_GRPOTENTIAL)},
    { 393, REB_DOUBLE,   "WHFAST512_ALLOCATEDN", offsetof(struct reb_simulation, WHFAST512_ALLOCATEDN)},
    { 394, REB_DOUBLE,   "WHFAST512_PJH", offsetof(struct reb_simulation, WHFAST512_PJH)},
    { 395, REB_DOUBLE,   "WHFAST512_PJH0", offsetof(struct reb_simulation, WHFAST512_PJH0)},
    { 1329743186, REB_DOUBLE, "HEADER", offsetof(struct reb_simulation, HEADER)},
    { 9998, REB_DOUBLE, "SABLOB", offsetof(struct reb_simulation, SABLOB)},
    { 9999, REB_DOUBLE, "END", offsetof(struct reb_simulation, END)},
};
