...
//    r->particles_varX[var_i+1].x = 1.;
//    reb_simulation_integrate(r,100.);
//    printf("Position of testparticle at t=100 using 2nd order var. eqs.:   %.8f %.8f\n",r->particles[2].x+DeltaX*r->particles_varX[var_i+2].x+DeltaX*DeltaX/2.*r->particles_varX[var_ii+2].x,r->particles[2].y+DeltaX*r->particles_varX[var_i+2].y+DeltaX*DeltaX/2.*r->particles_varX[var_ii+2].y);
//    reb_simulation_free(r);
//
//    
...
//    r->particles_varX[var_i].x = 1.;
//    reb_simulation_integrate(r,100.);
//    printf("Position of testparticle at t=100 using 1st order var. eqs.:   %.8f %.8f\n",r->particles[2].x+DeltaX*r->particles_varX[var_i].x,r->particles[2].y+DeltaX*r->particles_varX[var_i].y);
//    reb_simulation_free(r);
//
//    r = create_sim();
...
//    r->particles_varX[var_i].x = 1.;
//    reb_simulation_integrate(r,100.);
//    printf("Position of testparticle at t=100 using 2nd order var. eqs.:   %.8f %.8f\n",r->particles[2].x+DeltaX*r->particles_varX[var_i].x+DeltaX*DeltaX/2.*r->particles_varX[var_ii].x,r->particles[2].y+DeltaX*r->particles_varX[var_i].y+DeltaX*DeltaX/2.*r->particles_varX[var_ii].y);
//    reb_simulation_free(r);
//
//    
...
//    r->particles_varX[var_i] = reb_particle_derivative_a(1.,r->particles[0],r->particles[2]);
//    reb_simulation_integrate(r,100.);
//    printf("Position of testparticle at t=100 using 1st order var. eqs.:   %.8f %.8f\n",r->particles[2].x+DeltaX*r->particles_varX[var_i].x,r->particles[2].y+DeltaX*r->particles_varX[var_i].y);
//    reb_simulation_free(r);
//    
...
//    r->particles_varX[var_ii] = reb_particle_derivative_a_a(1.,r->particles[0],r->particles[2]);
//    reb_simulation_integrate(r,100.);
//    printf("Position of testparticle at t=100 using 2nd order var. eqs.:   %.8f %.8f\n",r->particles[2].x+DeltaX*r->particles_varX[var_i].x+DeltaX*DeltaX/2.*r->particles_varX[var_ii].x,r->particles[2].y+DeltaX*r->particles_varX[var_i].y+DeltaX*DeltaX/2.*r->particles_varX[var_ii].y);
//    reb_simulation_free(r);
//
