...
int main(int argc, char* argv[]){
    ...
    for (int i = 0; i < nbodies; i++){
      ...
      reb_add_fmt(r, "m r a e f Omega inc", planet_m, planet_r, sma, reb_random_uniform(r, 0., 0.05), reb_random_uniform(r, 0., 2.*M_PI),reb_random_uniform(r, 0., 2.*M_PI), (double)i * M_PI / 180.);
