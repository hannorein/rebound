...
int main(int argc, char* argv[]) {
	...
	p.x = -1.842389804706855;
	p.y = -1.063801316823613;
	p.vx = -0.012073765486548;
	p.vy = 0.021537467220014;
	reb_add(r, p);

	p.x = -0.689515464218133;
	p.y = -0.398759403276399;
	p.vx = 0.637331229856386;
	p.vy = -1.103822313621890;
	reb_add(r, p);
