...
In addition to reading the [API section](../api/index.md), you can learn most about REBOUND by looking at some of the [example problems](../examples.md). 
...
If you run into a problem or can't find an answer in this documentation, [open an issue](https://github.com/hannorein/rebound/issues) on GitHub or e-mail one of the [contributors](../index.md#contributors). 
