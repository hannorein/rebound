...
class TestEOSn(unittest.TestCase):
    ...
    def test_lf(self):
        ...
        self.sim.integrator_data.phi0 = "lf"
        self.sim.integrator_data.phi1 = "lf"
        self.sim.integrator_data.n = 16
    ...
    def test_lf4(self):
        ...
        self.sim.integrator = "eos"
        self.sim.integrator_data.phi0 = "lf4"
        self.sim.integrator_data.phi1 = "lf4"
        self.sim.integrator_data.n = 2
        self.sim.integrator_data.safe_mode = 0
        Emax = self._run()
    ...
    def test_lf4_2(self):
        self.sim.dt = 0.001*(2.*math.pi)
        self.sim.integrator = "eos"
        self.sim.integrator_data.phi0 = "lf4_2"
        self.sim.integrator_data.phi1 = "lf4"
        self.sim.integrator_data.n = 2
        self.sim.integrator_data.safe_mode = 0
        Emax = self._run()
    ...
    def test_pmlf4(self):
        self.sim.dt = 0.001*(2.*math.pi)
        self.sim.integrator = "eos"
        self.sim.integrator_data.phi0 = "pmlf4"
        self.sim.integrator_data.phi1 = "lf4"
        self.sim.integrator_data.n = 2
        self.sim.integrator_data.safe_mode = 0
        Emax = self._run()
    ...
    def test_lf6(self):
        self.sim.dt = 0.01*(2.*math.pi)
        self.sim.integrator = "eos"
        self.sim.integrator_data.phi0 = "lf6"
        self.sim.integrator_data.phi1 = "lf6"
        self.sim.integrator_data.n = 2
        self.sim.integrator_data.safe_mode = 0
        Emax = self._run()
    ...
    def test_lf8(self):
        ...
        self.sim.integrator = "eos"
        self.sim.integrator_data.phi0 = "lf8"
        self.sim.integrator_data.phi1 = "lf8"
        self.sim.integrator_data.n = 1
        self.sim.integrator_data.safe_mode = 0
        Emax = self._run()
    ...
    def test_lf8_6_4(self):
        self.sim.dt = 0.03*(2.*math.pi)
        self.sim.integrator = "eos"
        self.sim.integrator_data.phi0 = "lf8_6_4"
        self.sim.integrator_data.phi1 = "lf8"
        self.sim.integrator_data.n = 1
        self.sim.integrator_data.safe_mode = 0
        Emax = self._run()
    ...
    def test_plf7_6_4(self):
        self.sim.dt = 0.01*(2.*math.pi)
        self.sim.integrator = "eos"
        self.sim.integrator_data.phi0 = "plf7_6_4"
        self.sim.integrator_data.phi1 = "lf8"
        self.sim.integrator_data.n = 1
        self.sim.integrator_data.safe_mode = 0
        Emax = self._run()
