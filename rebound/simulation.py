...
class reb_simulation_integrator_trace(Structure):
    """
    This class is an abstraction of the C-struct reb_simulation_integrator_trace.
    ...
    _fields_ = [("_S", CFUNCTYPE(c_double, POINTER(Simulation), c_uint, c_uint)),
                ...
                ("_allocated_N_additionalforces", c_uint),
                ("_particles_backup", POINTER(Particle)),
                ("_particles_backup_try", POINTER(Particle)),
                ("_encounter_map", POINTER(c_int)),
                ("_encounter_map_internal", POINTER(c_int)),
                ("_com_pos", _Vec3d),
                ("_com_vel", _Vec3d),
...
Simulation._fields_ = [
                ...
                ("ri_tr", reb_simulation_integrator_trace),
...
TRACEKF = CFUNCTYPE(c_double, POINTER_REB_SIM, c_double, c_double)
TRACELF = CFUNCTYPE(c_double, POINTER_REB_SIM, c_double)
